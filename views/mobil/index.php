								...
								<form method="POST" action="<?= base_url('mobil/tambah') ?>" enctype="multipart/form-data">
									...
									<div class="row">
									  	<div class="form-group col-6">
									  		...
									  		<input type="text" name="no_polisi" id="no_polisi" required="required" placeholder="Nomor Polisi" autocomplete="off" class="form-control">
									  	</div>
									  	<div class="form-group col-6">
								  	...
								  	<div class="form-group">
								  		...
								  		<input type="file" name="gambar" id="gambar" required="required" placeholder="Upload Foto Mobil" autocomplete="off" class="form-control-file">
								  	</div>
								  	<div class="form-group">
